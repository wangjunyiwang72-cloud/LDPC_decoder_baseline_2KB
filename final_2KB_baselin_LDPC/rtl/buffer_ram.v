module buffer_ram #(
        ...
        parameter QC_LDPC_BLOCK_SIZE = 32   // 扩展因子
    ) (
        input wire sys_clk,
    ...
    genvar ii;
    generate
    for (ii=1; ii<=QC_LDPC_COL_COUNT; ii=ii+1) begin
        assign rr_data_ii = read_page ? page_1[ii-1][read_cnt] : page_0[ii-1][read_cnt];
    end
    endgenerate
