module ram_port_1_ctrl(
    ...
    assign addr_shif        = (addr_choice + (8'd32 - cyclic_shif) < 8'd32) ? (addr_choice + (8'd32 - cyclic_shif)) : (addr_choice - cyclic_shif);
